...
user-invocable: true
description: "Use when bootstrapping or repairing local setup: Python, Poetry, FFmpeg, and project dependency installation."
---
...
2. Run install_dependencies.ps1 for venv, FFmpeg, and Poetry setup.
3. Validate the launcher and command-line execution path.
