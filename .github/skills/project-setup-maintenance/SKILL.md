---
name: project-setup-maintenance
user-invocable: true
description: "Use when adding, updating, or repairing project setup scripts, dependency configuration, and onboarding steps."
---
...
2. Keep install paths, virtual environment assumptions, and launcher behavior consistent.
3. Run local validation for setup and smoke-check entrypoints.
