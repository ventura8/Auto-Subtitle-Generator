---
applyTo: "{install_dependencies.ps1,run_local_pipeline.ps1,pyproject.toml,.github/workflows/ci.yml}"
description: "Use when editing setup, installation, dependency, and local validation configuration files."
---
...
- Keep test-only dependencies in Poetry dev groups and avoid pip requirement file side-paths.
