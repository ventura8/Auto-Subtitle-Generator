---
applyTo: "{auto_subtitle.py,modules/**/*.py}"
description: "Use when changing pipeline architecture, module boundaries, orchestration flow, or model lifecycle behavior."
---
