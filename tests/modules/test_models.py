...
class TestModels(unittest.TestCase):
    ...
    def test_purge_cached_separator_checkpoint(self):
        ...
        with (
            ...
            self.assertIn("/fake/dir/test_model.ckpt", removed_files)
            self.assertIn("/fake/dir/test_model.yaml", removed_files)
            self.assertIn("/fake/dir/test_model.json", removed_files)
            self.assertNotIn("/fake/dir/test_model_backup.ckpt", removed_files)
            self.assertNotIn("/fake/dir/test_model.notes.txt", removed_files)
