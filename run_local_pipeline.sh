...
invoke_poetry run radon mi auto_subtitle.py modules tests -s | tee radon_mi_report.txt
...
invoke_poetry run radon hal auto_subtitle.py modules tests | tee radon_hal_report.txt
...
for cov_file in "auto_subtitle.py" "modules/configuration/config.py" "modules/pipeline/isolated_translator.py" "modules/models.py" "modules/pipeline/transcription.py" "modules/pipeline/translation.py" "modules/utils.py" "modules/workdir.py"; do
